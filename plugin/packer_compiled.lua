...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/root99/.local/share/nvim/site/pack/packer/opt/copilot.vim",
  ...
  harpoon = {
    loaded = true,
    path = "/home/root99/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  neoformat = {
    loaded = true,
    path = "/home/root99/.local/share/nvim/site/pack/packer/start/neoformat",
  ...
  ["nvim-treesitter"] = {
    loaded = true,
    path = "/home/root99/.local/share/nvim/site/pack/packer/start/nvim-treesitter",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/root99/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
    url = "https://github.com/nvim-telescope/telescope-fzf-native.nvim"
  },
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/root99/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["todo-comments.nvim"] = {
    ...
    loaded = true,
    path = "/home/root99/.local/share/nvim/site/pack/packer/start/todo-comments.nvim",
  ...
  ["vim-hexokinase"] = {
    loaded = true,
    path = "/home/root99/.local/share/nvim/site/pack/packer/start/vim-hexokinase",
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file coco lua require("packer.load")({'copilot.vim'}, { cmd = "coco", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
